...
class nanoKONTROL2(ControlSurface):   # Make sure you update the name
    __doc__ = " Script for nanoKONTROL2 in APC emulation mode "   # Make sure you update the name
    ...
    def _combine_active_instances():
        track_offset = 0
        scene_offset = 0
        for instance in nanoKONTROL2._active_instances:   # Make sure you update the name
    ...
    def _do_combine(self):
        if self not in nanoKONTROL2._active_instances:    # Make sure you update the name
            nanoKONTROL2._active_instances.append(self)   # Make sure you update the name
            nanoKONTROL2._combine_active_instances()  # Make sure you update the name

    def _do_uncombine(self):
        if (self in nanoKONTROL2._active_instances) and nanoKONTROL2._active_instances.remove(self):    # Make sure you update the name
