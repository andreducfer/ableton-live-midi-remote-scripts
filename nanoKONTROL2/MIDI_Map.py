...
TSB_Y = 3   # Controls the horizontal value for the track selection box. Default value is 8

# General
PLAY = 41   # Global play
STOP = 42   # Global stop
REC = 45    # Global record
...
SEEKFWD = 44  # Seek forward
SEEKRWD = 43  # Seek rewind

# Session Navigation (aka "red box")
SESSIONLEFT = 58  # Session left
SESSIONRIGHT = 59  # Session right
SESSIONUP = 61  # Session up
SESSIONDOWN = 62  # Session down
...
STOPALLCLIPS = 60  # Stop all clips

# 8x8 Matrix note assignments
# Track no.:     1   2   3   4   5   6   7   8
CLIPNOTEMAP = ((32, 33, 34, 35, 36, 37, 38, 39),  # Row 1
